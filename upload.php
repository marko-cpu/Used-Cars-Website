...
if(isset($_POST["unosvozila"])){
    ...
    if(in_array($fileActualExt, $allowed)){
        if($fileError === 0){
            ...
            if (!file_exists("/opt/lampp/htdocs/Projects/Used-Cars-Listings-Website-PHP/images/oglasi/". strval($broj_oglasa))) {
                mkdir("/opt/lampp/htdocs/Projects/Used-Cars-Listings-Website-PHP/images/oglasi/". strval($broj_oglasa), 0777, true);}
            $fileDestination = "/opt/lampp/htdocs/Projects/Used-Cars-Listings-Website-PHP/images/oglasi/". strval($broj_oglasa)."/".$fileNameNew;
